 ...
 * @param {String} eventType even type
...
const searchTimeoutDuration = 50;
...
searchField.addEventListener("input", function () {
    ...
    } else searchField.classList.add("searching");
    if (searchField.value) {
        searchTimeout = setTimeout(() => {
            fetchData(url.directGeocoding(searchField.value), function (locations) {
                searchField.classList.remove("searching");
...
export const updateWeather = function (lat, lon) {
    ...
    if (window.location.hash === "#/weather-location")
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            hourlyForecastSection.innerHTML = `
                ...
                <div class="slider-container">
                    <ul class="slider-list" data-temperature></ul>
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                `;
                hourlyForecastSection.querySelector("[data-temperature]").appendChild(temperatureLi);
            ...
            for (let i = 7, len = forecastList.length; i < len; i += 8) {
                ...
                li.innerHTML = `
                    <div class="icon-wrapper">
                        <img src="./assets/images/weather_icons/${icon}.png" width="36" height="36" class="weather-icon" alt="${description}" title="${description}">
                        <span class="span">
                            <p class="title-2">${parseInt(temp_max)}&deg;</p>
                        </span>
                    </div>
                    <p class="label-1">${date.getDate()} ${module.yearMonths[date.getUTCMonth()]
                            }</p>
